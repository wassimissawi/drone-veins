...
//command: sunscribe drone context

#define CMD_SUBSCRIBE_DRONEUAV_CONTEXT 0x84
// response: subscribe drone context
#define RESPONSE_SUBSCRIBE_DRONEUAV_CONTEXT 0x94
// command: get drone variable
#define CMD_GET_DRONEUAV_VARIABLE 0xa4
// response: get drone variable
#define RESPONSE_GET_DRONEUAV_VARIABLE 0xb4
// command: set drone variable
#define CMD_SET_DRONEUAV_VARIABLE 0xc4
// command: subscribe drone variable
#define CMD_SUBSCRIBE_DRONEUAV_VARIABLE 0xd4
// response: subscribe drone variable
#define RESPONSE_SUBSCRIBE_DRONEUAV_VARIABLE 0xe4
